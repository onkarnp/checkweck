  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to checkweck</h4>
            <img src="images/Checkweck.png" alt="Logo" style="width:100px;height:100px;"><h  r>
            <p style="max-width: 80%;">
            CHECKWECK  is a Decentralized Entity 2 Entity Product Legitimacy Platform that stores the whereabouts of products. At the consumer end, customers can simply scan the QR CODE of products and get complete information about the source of that product, therefore entrusting consumers to only purchase authentic and quality products.
            </p>
