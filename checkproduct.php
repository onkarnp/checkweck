...
<html lang="en">
      ...
      <center>
		...
		<i class='fa fa-qrcode'></i> Scan QR
          ...
          <p id="database" class="cardstyle">
            No product with given input exist!
          </p>
        </div>
      </center>
    </div>
  ...
  <?php }else{
    ...
    $("#aboutbtn").on("click", function(){
        showAlert("CHECKWECK is a Decentralized Entity 2 Entity Product Legitimacy Platform that stores the whereabouts of products. At the consumer end, customers can simply scan the QR CODE of products and get complete information about the source of that product, therefore entrusting consumers to only purchase authentic and quality products.");
    });
